...
<div class="max-w-md mx-auto mt-8 px-4 sm:px-6 lg:px-8">
    <div class="bg-white p-6 sm:p-8 rounded shadow">
        <h1 class="text-xl sm:text-2xl font-bold mb-6 text-center">📝 Inscription</h1>
                ...
                <div class="space-y-2">
                    <label class="inline-flex items-center gap-2">
                        <input type="radio" name="account_type" value="parent"
                               class="border rounded" {{ old('account_type') === 'parent' ? 'checked' : '' }} required>
                        <span>Compte parent</span>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input type="radio" name="account_type" value="child"
                               class="border rounded" {{ old('account_type') === 'child' ? 'checked' : '' }} required>
